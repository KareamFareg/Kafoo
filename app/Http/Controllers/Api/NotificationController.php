...
//        dd( NotificationResource::collection($data));
    ...
    public function send_notification(Request $request)
    {
        ...
        // ]);
         ...
         $result = $this->notificationServ->notifyOrder(
            ['fcm', 'db'],
    ...
    if($result == true){
        ...
        $response = ['message' => ['error' => trans('messages.added_failed')]];
    }
    ...
    public function getUnreadNotificationByUserId($userid)
    {
        ...
        $data = $this->notificationServ->getUnreadNotificationByUserId($userid);
    ...
    public function getUnreadNotificationCountByUserId($userid)
    {
        ...
        $data = $this->notificationServ->getUnreadNotificationCountByUserId($userid);
