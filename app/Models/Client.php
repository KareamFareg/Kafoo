...
class Client extends Model
{
    ...
    protected $fillable = [
        'id','title_general','name','mobile_type','bank_name','fcm_token','country_id','contacts','email','phone','parent_id','referenceCode' , 'TawseelErrorMessage','notify_mail','mobile','administrator','is_active','is_active_admin','user_id','ip',
    ];
