...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'type_id', 'parent_id', 'name', 'bankname','user_name', 'phone','card_number', 'email', 'gender', 'license', 'city', 'id_number', 'id_card','refrenceCode' ,'idNumber','identityTypeId','TawseelErrorMessage',
    ...
    public function deserved_amount($ordersIds, $commission_status = 1)
    {
