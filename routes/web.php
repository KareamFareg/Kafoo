...
Route::get('bankhosted', function () {
    return view('bankhosted');
 })->name('bankhosted');
 Route::get('merchanthosted', function () {
    return view('merchanthosted');
 })->name('merchanthosted');
    ...
    Route::group([
        ...
        Route::group([
            ...
            'as' => 'admin.messages.',
             ...
             Route::get('order/{id}', 'FirebaseController@orders')->name('orders');
        });
