...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form class="kt_form_1 row" enctype="multipart/form-data" action="<?php echo e(route('admin.commission.not_paid')); ?>"
                method="post">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($shipper->orders_price($ordersIds, 0)); ?></td>
                        <td><?php echo e($shipper->shipping_price($ordersIds, 0)); ?></td>
                        
                        <td><?php echo e($shipper->commission($ordersIds, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->discount($ordersIds, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->payment($ordersIds,1, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->payment($ordersIds,2, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->payment($ordersIds,3, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->charge_wallet($ordersIds, 0)); ?> ريال  </td>
                        <td><?php echo e($shipper->deserved_amount($ordersIds, 0)); ?> ريال  </td>
                    </tr>
                    <?php
                    $totalOrderPrice += $shipper->orders_price($ordersIds, 0);
                    $totalShippingPrice += $shipper->shipping_price($ordersIds, 0);
                    $totalCommission += $shipper->commission($ordersIds, 0);
                    $totalDiscount += $shipper->discount($ordersIds, 0);
                    $totalCash += $shipper->payment($ordersIds,1, 0);
                    $totalWalet += $shipper->payment($ordersIds,2, 0);
                    $totalOnline += $shipper->payment($ordersIds,3, 0);
                    $totalcharge_wallet += $shipper->charge_wallet($ordersIds, 0);
                    $totalDesevedMore += $shipper->deserved_amount($ordersIds, 0);
                    ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kafoosaappsjanna/lara/resources/views/admin/commissions/not_paid.blade.php ENDPATH**/ ?>