<!-- <script src="<?php echo e(asset('assets/admin/vendors/custom/datatables/datatables.bundle.js')); ?>" type="text/javascript"></script> -->
...
<!-- <script src="<?php echo e(asset('assets/admin/js/demo1/pages/crud/datatables/advanced/multiple-controls.js')); ?>" type="text/javascript"></script> -->
...
<script>
    $(document).ready(function() {
        ...
        $('#kt_table_2 tr:last').remove(); 


        var deleteWord = "<?php echo e(trans('words.delete')); ?>";
...
function delete_list(url ,type='DELETE'){
    ...
    if(dataList.length >0){
        ...
        var deleteWord = "<?php echo e(trans('words.delete')); ?>";
                    ...
                    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                  Swal.fire({
                    title: "<?php echo e(trans('messages.confirm_delete_title')); ?>" , 
                    text:  "<?php echo e(trans('messages.confirm_delete_text')); ?>" , 
                    type: 'warning', 
                        ...
                        console.log('begain delete');
                              ...
                              success: function (data) {
                                  if(data['success']) {
                                    ...
                                    Swal.fire( { title: "<?php echo e(trans('messages.deleted')); ?>", type: "success" });
                                  }
...
</script><?php /**PATH /home/kafoosaappsjanna/lara/resources/views/components/admin/datatable/footer-js.blade.php ENDPATH**/ ?>