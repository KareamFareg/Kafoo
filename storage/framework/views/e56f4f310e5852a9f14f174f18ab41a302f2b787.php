...
<script>
  ...
  last_notification_id=<?php echo e(optional(\App\Models\Notification::where(['user_reciever_id'=>0,'read_at'=>null])->orderBy('id','desc')->first())->id ?? 0); ?>;
...
//    $.ajax({
//       type: 'post',
//       url: "<?php echo e(route('admin.users.fcm_web')); ?>",
//       data: { 'token' : token },
...
$("#clear_notification" ).click(function() {
  ...
  counter.innerHTML = 0;
   ...
   $.ajax({
      type: 'get',
      url: "<?php echo e(route('admin.users.notification_readed')); ?>",
      success: function (data) {
...
setInterval( () =>{
 // console.log(last_notification_id);
  $.ajax({
      type: 'get',
      url: "<?php echo e(url('api/v1/getAdminNewNotifications')); ?>"+'/'+last_notification_id,
      success: function (data) {
...
<?php /**PATH /home/kafoosaappsjanna/lara/resources/views/components/firebase/notify.blade.php ENDPATH**/ ?>