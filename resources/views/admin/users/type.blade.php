      ...
      <table class="table table-striped table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tbody>
          ...
          <tr id="{{ $item->id }}">
            ...
            <td>{{ $item->phone }}</td>
            <td>{{ ($item->gender == 'male' || $item->gender == 'mail')  ?  __('user.male') :   __('user.female') }}</td>
            <td>{{  $item->amount}}</td>
            <td>{{$item->iBanNum}}</td>
            <td>{{$item->benificiaryName}}</td>
            <td>{{$item->bankIdCode}}</td>
        ...
        <tbody>
          ...
          <tr id="{{ $item->id }}">
            ...
            <td>{{ $item->phone }}</td>
            <td>{{ ($item->gender == 'male') ||  ($item->gender == 'male,')  || ( $item->gender == 'mail') ?  __('user.male') :   __('user.female') }}</td>
            <td>{{$item->iBanNum}}</td>
            <td>{{$item->benificiaryName}}</td>
            <td>{{$item->bankIdCode}}</td>
