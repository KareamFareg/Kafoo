              ...
              <div class="kt-chat__input">
                ...
                <div class="kt-chat__toolbar">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="modal-footer">
                              ...
                              <button data-dismiss="modal" class=" btn btn-success " onclick="sendMessage('{{optional($user)->id}}',$('#lat').val()+','+$('#lng').val(),'4')">
                  ...
                  <div class="kt_chat__actions">
                    <button type="button" onclick="sendMessage('{{optional($user)->id}}',$('#text').val(),'1')"
...
<script>
  var config = {
    ...
    task.on('state_changed', function progress(snapshot) {
      ...
      sendMessage('{{optional($user)->id}}',downloadURL,'2')
      });
